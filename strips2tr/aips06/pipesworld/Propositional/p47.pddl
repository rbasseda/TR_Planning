...
(define (problem p47_net5_b28_g5_rt0_instance)
  (:domain pipesworld_strips)
  (:objects

    	b10 b21 b17 b14 b27 b22 b4 b6 b15 b19 b20 b13 b8 b2 b11 b24 b5 b0 b1 b25 b18 b7 b12 b9 b3 b26 b23 b16 - batch_atom
	a1 a2 a3 a4 a5 - area
	s12 s13 s34 s23 s15 - pipe
	ta1_4_lco ta1_3_lco ta1_2_lco ta1_1_lco - tank_slot
	ta1_3_gasoleo ta1_2_gasoleo ta1_1_gasoleo - tank_slot
	ta1_4_rat_a ta1_3_rat_a ta1_2_rat_a ta1_1_rat_a - tank_slot
	ta1_2_oca1 ta1_1_oca1 - tank_slot
	ta1_2_oc1b ta1_1_oc1b - tank_slot
	ta2_4_lco ta2_3_lco ta2_2_lco ta2_1_lco - tank_slot
	ta2_3_gasoleo ta2_2_gasoleo ta2_1_gasoleo - tank_slot
	ta2_4_rat_a ta2_3_rat_a ta2_2_rat_a ta2_1_rat_a - tank_slot
	ta2_2_oca1 ta2_1_oca1 - tank_slot
	ta2_2_oc1b ta2_1_oc1b - tank_slot
	ta3_4_lco ta3_3_lco ta3_2_lco ta3_1_lco - tank_slot
	ta3_3_gasoleo ta3_2_gasoleo ta3_1_gasoleo - tank_slot
	ta3_4_rat_a ta3_3_rat_a ta3_2_rat_a ta3_1_rat_a - tank_slot
	ta3_2_oca1 ta3_1_oca1 - tank_slot
	ta3_2_oc1b ta3_1_oc1b - tank_slot
	ta4_4_lco ta4_3_lco ta4_2_lco ta4_1_lco - tank_slot
	ta4_3_gasoleo ta4_2_gasoleo ta4_1_gasoleo - tank_slot
	ta4_4_rat_a ta4_3_rat_a ta4_2_rat_a ta4_1_rat_a - tank_slot
	ta4_2_oca1 ta4_1_oca1 - tank_slot
	ta4_2_oc1b ta4_1_oc1b - tank_slot
	ta5_4_lco ta5_3_lco ta5_2_lco ta5_1_lco - tank_slot
	ta5_3_gasoleo ta5_2_gasoleo ta5_1_gasoleo - tank_slot
	ta5_4_rat_a ta5_3_rat_a ta5_2_rat_a ta5_1_rat_a - tank_slot
	ta5_2_oca1 ta5_1_oca1 - tank_slot
	ta5_2_oc1b ta5_1_oc1b - tank_slot
  ...
  (:init
	...
	(tank_slot_product_location ta5_4_lco lco a5)
	(tank_slot_product_location ta5_3_lco lco a5)
	(tank_slot_product_location ta5_2_lco lco a5)
	...
	(tank_slot_product_location ta5_4_rat_a rat_a a5)
	(tank_slot_product_location ta5_3_rat_a rat_a a5)
	...
	(is_product b21 gasoleo)
	(is_product b17 gasoleo)
	(is_product b14 gasoleo)
	(is_product b27 rat_a)
	(is_product b22 rat_a)
	(is_product b4 rat_a)
	(is_product b6 lco)
	(is_product b15 rat_a)
	(is_product b19 rat_a)
	(is_product b20 rat_a)
	(is_product b13 oca1)
	(is_product b8 lco)
	...
	(on b4 a5)
	(occupied ta5_1_rat_a)
	
	(on b15 a5)
	(occupied ta5_2_rat_a)
	...
	(not_occupied ta5_2_lco)
	(not_occupied ta5_3_lco)
	(not_occupied ta5_4_lco)
	(not_occupied ta5_2_gasoleo)
	(not_occupied ta5_3_gasoleo)
	(not_occupied ta5_3_rat_a)
	(not_occupied ta5_4_rat_a)
