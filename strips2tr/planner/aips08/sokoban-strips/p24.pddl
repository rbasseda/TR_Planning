...
(define (problem p121_microban_sequential)
  ...
  (:init
    ...
    (move_dir pos_07_10 pos_08_10 dir_right)
    (move_dir pos_08_01 pos_08_02 dir_down)
    (move_dir pos_08_01 pos_09_01 dir_right)
    (move_dir pos_08_02 pos_08_01 dir_up)
    ...
    (move_dir pos_08_10 pos_07_10 dir_left)
    ...
    (at stone_03 pos_03_06)
    (at stone_04 pos_07_09)
    (at stone_05 pos_09_09)
    (at_goal stone_02)
    (clear pos_01_01)
    (clear pos_01_02)
    (clear pos_01_11)
