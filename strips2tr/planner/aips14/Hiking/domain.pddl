...
(at_person ?x1 ?x2)(at_tent ?x3 ?x2)(down ?x3))
  ...
  (:action drive_passenger
         ...
         :precondition (and 
(at_person ?x1 ?x2)(at_car ?x4 ?x2)(at_person ?x5 ?x2) (= ?x1 ?x5))
...
(at_tent ?x5 ?x3)(not (at_tent ?x5 ?x2))
  ...
  (:action drive_tent_passenger
         ...
         :precondition (and 
(at_person ?x1 ?x2)(at_car ?x4 ?x2)(at_tent ?x5 ?x2)(down ?x5)(at_person ?x6 ?x2)(= ?x1 ?x6))
         :effect (and (at_person ?x1 ?x3)(not (at_person ?x1 ?x2))
(at_car ?x4 ?x3)(not (at_car ?x4 ?x2))
(at_tent ?x5 ?x3)(not (at_tent ?x5 ?x2))
(at_person ?x6 ?x3)(not (at_person ?x6 ?x2))
  ...
  (:action walk_together
         ...
         :precondition (and 
(at_tent ?x1 ?x2)(up ?x1)(at_person ?x3 ?x4)(next ?x4 ?x2)(at_person ?x5 ?x4)(= ?x3 ?x5)(walked ?x6 ?x4)(partners ?x6 ?x3 ?x5))
