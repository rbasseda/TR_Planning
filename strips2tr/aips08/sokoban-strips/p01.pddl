...
(define (problem p024_microban_sequential)
  ...
  (:init
    ...
    (is_nongoal pos_7_6)
    (is_nongoal pos_7_7)
    (move_dir pos_1_2 pos_2_2 dir_right)
    (move_dir pos_2_1 pos_2_2 dir_down)
    (move_dir pos_2_2 pos_1_2 dir_left)
    (move_dir pos_2_2 pos_2_1 dir_up)
