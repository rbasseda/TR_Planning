...
(define (problem p126_microban_sequential)
  ...
  (:init
    ...
    (move_dir pos_11_07 pos_12_07 dir_right)
    (move_dir pos_12_05 pos_12_06 dir_down)
    (move_dir pos_12_06 pos_12_05 dir_up)
    (move_dir pos_12_06 pos_12_07 dir_down)
    (move_dir pos_12_07 pos_11_07 dir_left)
    (move_dir pos_12_07 pos_12_06 dir_up)
    (at player_01 pos_10_03)
    (at stone_01 pos_03_03)
    (at stone_02 pos_04_03)
    (at stone_03 pos_05_03)
    (at stone_04 pos_06_03)
    (at stone_05 pos_07_03)
    (at stone_06 pos_08_03)
    (at stone_07 pos_09_03)
    (clear pos_01_01)
    (clear pos_02_03)
    (clear pos_02_04)
    (clear pos_02_05)
