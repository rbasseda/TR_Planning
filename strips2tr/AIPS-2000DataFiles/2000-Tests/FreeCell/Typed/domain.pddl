...
;;; with macro_moves  (actions that generate worm_holes in the search
;;; space) and hand_tailored heurisics tlplan is able to solve about
;;; 90% of the randomly generated games. unfortunately, the
;;; macro_moves need action descriptions that include recursive 
...
;;; 
;;; (value card val)   ___ the face value of the card. (1, ..., 13)
;;; (suit card st)     ___ the suit of the card. (c, d, h, s)
;;;   e.g., (value ca 1) (suit ca c)
;;; (successor n' n)   ___ n' = n+1, for n=0,...,12, n'=1,...,13
...
;;; dynamic predicates:
;;;
;;; (on card1 card2)	__ card1 is on card2
;;; (incell card)	___ card is in a freecell.
;;; (clear card)	___ card is clear (i.e., on top of a column).
;;; (cellspace n)	___ there are n free freecells.
;;;                                n = 0, 1, 2, 3, or 4
;;; (colspace n)	___ there are n free columns. n=0,..,8
;;; (home card)		___ card is a top card in a home stack.
;;;			    we use the special (home c0),
;;;			    (home d0), (home h0), (home s0).
;;;			    to indicate that home is empty for a
;;;			    particular suit.
;;; (bottomcol card)	__  card is at the bottom of a stack.
;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
